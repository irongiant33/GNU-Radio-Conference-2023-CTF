...
class demod101(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_symbol_sync_xx_0 = digital.symbol_sync_ff(
            ...
            128,
            [])
        self.digital_correlate_access_code_tag_xx_0 = digital.correlate_access_code_tag_bb('101010101010101010', 1, 'frame_start')
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_time_sink_x_0_1.set_samp_rate(self.samp_rate / self.decimation)
