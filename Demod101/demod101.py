...
class demod101(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.stop_time = stop_time = 1.2
        self.start_time = start_time = 0.5
        self.samp_rate = samp_rate = 480e3
        self.decimation = decimation = 40
        self.variable_low_pass_filter_taps = variable_low_pass_filter_taps = firdes.low_pass(1.0, samp_rate, 5e3,1e3, window.WIN_HAMMING, 6.76)
        self.symbol_rate = symbol_rate = 800
        self.max_pdu_size = max_pdu_size = int((stop_time - start_time) * (samp_rate / decimation))
        self.fsk_deviation_hz = fsk_deviation_hz = 2.4e3
        self.frequency_shift = frequency_shift = 15.56e3
        ...
        self.single_pole_iir_filter_xx_0 = filter.single_pole_iir_filter_ff((10e-3), 1)
        self.sigmf_sink_0 = gr_sigmf.sink("rf32", '/home/dragon/Documents/GNU-Radio-Conference-2023-CTF/Demod101/part1_beforesymbolsync.sigmf-data', gr_sigmf.sigmf_time_mode_relative, False)
        self.sigmf_sink_0.set_global_meta("core:sample_rate", (samp_rate / decimation))
    ...
    def set_max_pdu_size(self, max_pdu_size):
        self.max_pdu_size = max_pdu_size
        self.pdu_tags_to_pdu_x_0.set_max_pdu_size(self.max_pdu_size)
